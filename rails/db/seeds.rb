...
ActiveRecord::Base.transaction do
 ...
 Nav.find_or_create_by_item :item=>'getready', :parent_item=>'nodes', :name=>'nav.getready', :description=>'nav.getready_description', :path=>"main_app.getready_path", :order=>3000
Nav.find_or_create_by_item :item=>'bulk_edit', :parent_item=>'nodes', :name=>'nav.bulk_edit', :description=>'nav.bulk_edit_description', :path=>"main_app.bulk_edit_path", :order=>4000
